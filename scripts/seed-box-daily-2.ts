...
async function seed() {
  const { data, error } = await supabase
    ...
    .insert([
      ...
      {
        user_id: USER_ID, wardrobe_id: WARDROBE_ID,
        name: 'Shorts Light Tan Outdoor Quickdry',
        category: 'bottom', subcategory: null, item_type: 'shorts',
        color: 'Light Tan', image_url: '', status: 'verified',
        purchase_date: '2026-09-05',
      },
      {
        user_id: USER_ID, wardrobe_id: WARDROBE_ID,
        name: 'Shorts Pure White',
        category: 'bottom', subcategory: null, item_type: 'shorts',
      ...
      {
        user_id: USER_ID, wardrobe_id: WARDROBE_ID,
        name: 'Shorts Dark Gray With Green Accent',
        category: 'bottom', subcategory: null, item_type: 'shorts',
        color: 'Dark Gray Green', image_url: '', status: 'verified',
        purchase_date: '2026-09-05',
      },
      {
        user_id: USER_ID, wardrobe_id: WARDROBE_ID,
        name: 'Track Pants Dark Gray',
        category: 'bottom', subcategory: null, item_type: 'jogger',
        color: 'Dark Gray', image_url: '', status: 'verified',
        purchase_date: '2026-09-05',
      },
      {
        user_id: USER_ID, wardrobe_id: WARDROBE_ID,
        name: 'Shorts White With Compression Gym',
        category: 'bottom', subcategory: null, item_type: 'shorts',
        color: 'White', image_url: '', status: 'verified',
        purchase_date: '2026-09-05',
      },
