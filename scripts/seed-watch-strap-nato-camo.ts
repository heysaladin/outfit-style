...
async function seed() {
  const { data, error } = await supabase
    ...
    .insert([{
      user_id: USER_ID,
      name: 'Tali Jam Tangan Strap Jam Premium Nato Strap Camo Army - NC3 - 20mm',
      category: 'fashion',
      subcategory: 'aksesori',
      color: 'Camo Gray Army',
      image_url: 'https://down-id.img.susercontent.com/file/sg-11134201-7qvfv-lhr7d6cuyvvyaf',
      status: 'verified',
      wear_count: 0,
      target: 10,
    }])
